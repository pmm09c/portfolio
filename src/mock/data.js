...
export const aboutData = {
  ...
  paragraphTwo:
    "Since then, I've spent a lot of time throwing myself into different applications of data driven learning methods. At the start, I did a lot of work in computer vision; checkout the below for some smaple projects. But more recently, a lot of my time has been dedicated to autonomy. Specifically, programming machines to learn to make decisions that usually humans script or do themselves. All of this, I've had the great opportunity to do at MIT Lincoln Laboratory, where currently I sit in the AI Technology group.",
  paragraphThree:
...
export const projectsData = [
  ...
  },
  {
    ...
    info2:
      "The second project is using something known as Scientific Machine Learning, a form of machine learning which attempts to maintain as much structure from the physics of a problem in the learning, to try and navigate the earth using only the magnetic field generated from the earth's crust.",
